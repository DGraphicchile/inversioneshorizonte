...
export const MOCK_PROJECTS: Project[] = [
  {
    ...
    estimated_return_min: 15.2,
    estimated_return_max: 15.2,
    annual_return: 15.2,
    duration_months: 12,
    deadline: '2026-09-30',
  ...
  },
  {
    ...
    min_investment: 250_000,
    estimated_return_min: 15.8,
    estimated_return_max: 15.8,
    annual_return: 15.8,
    duration_months: 12,
    deadline: '2026-07-31',
    location: 'Santiago, Región Metropolitana',
  ...
  },
  {
    ...
    estimated_return_min: 17.9,
    estimated_return_max: 17.9,
    annual_return: 17.9,
    duration_months: 11,
    deadline: null,
    location: 'Santiago, Región Metropolitana',
